...
class Butterier implements Runnable {
    private ToastQueue dryQueue, butteredQueue;

    public Butterier(ToastQueue dryQueue, ToastQueue butteredQueue) {
    ...
    public void run() {
        try {
            ...
            System.out.println("Butterier interrupted.");
        }
...
public class ToastOMatic {
    public static void main(String[] args) throws InterruptedException {
        ...
        exec.execute(new Butterier(dryQueue, butteredQueue));
